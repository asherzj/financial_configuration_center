...
export interface components {
    schemas: {
        ...
        Session: {
            ...
            displayName: string;
            roles: string[];
            allowedScopes: components["schemas"]["Scope"][];
            featureFlags: {
                [key: string]: boolean;
            };
        };
...
export interface operations {
    beginOIDCLogin: {
        ...
        requestBody?: never;
        responses: {
            /** @description Redirect to the configured OIDC authorization endpoint with PKCE */
            302: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    completeOIDCLogin: {
        ...
        requestBody?: never;
        responses: {
            /** @description Session cookies issued and browser redirected to the local success path. */
            302: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    logout: {
        ...
        requestBody?: never;
        responses: {
            /** @description Session and CSRF cookies cleared. */
            204: {
                headers: {
                    [name: string]: unknown;
                };
