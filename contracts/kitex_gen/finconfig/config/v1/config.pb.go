...
const file_finconfig_config_v1_config_proto_rawDesc = "" +
	...
	"\x13GetCollectionStatus\x12/.finconfig.config.v1.GetCollectionStatusRequest\x1a0.finconfig.config.v1.GetCollectionStatusResponseB[ZYgithub.com/asherzj/financial_configuration_center/contracts/kitex_gen/finconfig/config/v1b\x06proto3"
...
type ConfigService interface {
	GetSnapshot(ctx context.Context, req *GetSnapshotRequest) (res *GetSnapshotResponse, err error)
	DiffVersions(ctx context.Context, req *DiffVersionsRequest) (res *DiffVersionsResponse, err error)
	GetCollections(ctx context.Context, req *GetCollectionsRequest) (res *GetCollectionsResponse, err error)
	Watch(req *WatchRequest, stream ConfigService_WatchServer) (err error)
}
...
type PageQueryService interface {
	QueryPage(ctx context.Context, req *QueryPageRequest) (res *QueryPageResponse, err error)
}

type RefreshService interface {
	Notify(ctx context.Context, req *NotifyRequest) (res *NotifyResponse, err error)
}

type DiagnosticsService interface {
	GetSnapshotStatus(ctx context.Context, req *GetSnapshotStatusRequest) (res *GetSnapshotStatusResponse, err error)
	GetCollectionStatus(ctx context.Context, req *GetCollectionStatusRequest) (res *GetCollectionStatusResponse, err error)
}
