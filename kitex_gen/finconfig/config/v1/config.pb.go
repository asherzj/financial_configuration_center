...
const file_finconfig_config_v1_config_proto_rawDesc = "" +
	...
	"\x13GetCollectionStatus\x12/.finconfig.config.v1.GetCollectionStatusRequest\x1a0.finconfig.config.v1.GetCollectionStatusResponseBQZOgithub.com/asherzj/financial_configuration_center/kitex_gen/finconfig/config/v1b\x06proto3"
